...
?>
<div class="card" ng-controller="fluidFieldController" ng-init="_field='<?php echo base64_encode(json_encode($field_meta)); ?>'">
		...
		<div class="d-flex flex-column" data-ng-show="field.children.length > 0">
        	...
        	<div class="d-flex flex-column p-1">
        		<div ng-repeat="ft in field.children track by ft.row_name" class="card mb-2">
        			...
        			<div class="d-none">
        				<input type="text" name="{{field.name}}[fields][{{ft.row_name}}][{{ft.name}}]" ng-model="ft.value">
        			</div>
        		</div>
        	</div>
        </div>
